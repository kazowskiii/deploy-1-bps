...
const ONEDRIVE_FOLDER = process.env.ONEDRIVE_FOLDER || 'SIMAMORA-Uploads';
...
/**
 * Pastikan folder ada, termasuk folder bertingkat (mis. "SIMAMORA-FRA/Triwulan 1/IKU 3").
 ...
 * `folderName` opsional — boleh berupa path bertingkat, mis. "SIMAMORA-FRA/Triwulan 1/IKU 3".
